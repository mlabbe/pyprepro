...
#def get_all_variables_from_preamble(preamble):
#    for line in preamble:
#        if

def get_in_files_from_preamble_in_line(in_lines, root_dir, out_dir, src_path):
    file_list = []
...
for path in scannable_files:
    ...
    if MAGIC_STR in head:
        ...
        #vars = get_all_variables_from_preamble(preamble)
        #print("vars:")
        #print(preamble)
        #sys.exit(1)
